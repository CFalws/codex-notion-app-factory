...
Lock the already-present selected-thread switch continuity path into the proposal artifacts.
...
6. Align focused verification and proposal artifacts with the iteration-181 switch-continuity contract.
