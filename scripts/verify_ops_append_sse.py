...
def main() -> int:
    ...
    require(render_js, "collapsedSessionSummary", label="collapsed session summary helper")
    ...
    require(render_js, 'dom.sessionStripToggle.textContent = shouldCollapse ? "세부 보기" : "접기"', label="session rail toggle copy")
    ...
    require(styles_css, ".session-strip-toggle", label="session rail toggle CSS")
    require(styles_css, '.session-strip[data-session-collapsed="true"]', label="collapsed session rail CSS")
