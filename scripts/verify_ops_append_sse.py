...
def main() -> int:
    ...
    autonomy_context_index = index_html.index('id="autonomy-context-strip"')
    ...
    if not (autonomy_context_index < thread_scroller_index):
    ...
    require(index_html, 'id="autonomy-context-strip"', label="compact autonomy context strip DOM")
    ...
    require(styles_css, ".autonomy-context-strip", label="compact autonomy context strip CSS")
    require(styles_css, ".autonomy-detail-card", label="secondary panel autonomy detail card CSS")
    require(styles_css, ".autonomy-context-line", label="compact autonomy line CSS")
    require(styles_css, ".autonomy-context-iteration", label="compact autonomy iteration CSS")
