...
export function deriveSelectedThreadSessionSurfaceModel(currentState, conversation = null) {
  ...
  return {
    ...
    pathVerdictLabel: liveOwned ? String(summary?.pathVerdict || "UNKNOWN").toUpperCase() : "",
    verifierAcceptabilityLabel: liveOwned ? String(summary?.verifierAcceptability || "PENDING").toUpperCase() : "",
    blockerReasonLabel: liveOwned ? String(summary?.blockerReason || "none").toUpperCase() : "",
